...
var Context.mockStep: Boolean
    get() = sharedPrefs.getBoolean("mockStep", FakeLoc.enableMockStep)
    set(value) = sharedPrefs.edit {
        putBoolean("mockStep", value)
        FakeLoc.enableMockStep = value
    }

var Context.stepFrequency: Int
    get() = sharedPrefs.getInt("stepFrequency", FakeLoc.stepFrequency)
    set(value) = sharedPrefs.edit {
        putInt("stepFrequency", value)
        FakeLoc.stepFrequency = value
    }

var Context.stepBaseCount: Long
    get() = sharedPrefs.getLong("stepBaseCount", FakeLoc.stepBaseCount)
    set(value) = sharedPrefs.edit {
        putLong("stepBaseCount", value)
        FakeLoc.stepBaseCount = value
    }
